...
public class StringUtils {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String string_date = "28-March-2019-19";

			SimpleDateFormat f = new SimpleDateFormat("dd-MMM-yyyy-HH");
			
			Date d = f.parse(string_date);
			long milliseconds = d.getTime();
			System.out.println(milliseconds);
			
//			String html = "&amp;lt;OnDemandRequest&amp;gt;&amp;lt;Type&amp;gt;Flight&amp;lt;/Type&amp;gt;&amp;lt;UseFltOrgDate&amp;gt;true&amp;lt;/UseFltOrgDate&amp;gt;&amp;lt;DepartureTimeWindow&amp;gt;&amp;lt;BeginDuration&amp;gt;-P2D&amp;lt;/BeginDuration&amp;gt;&amp;lt;EndDuration&amp;gt;P4D&amp;lt;/EndDuration&amp;gt;&amp;lt;/DepartureTimeWindow&amp;gt;&amp;lt;Key&amp;gt;&amp;lt;AirlineCode&amp;gt;&amp;lt;IATA&amp;gt;AA&amp;lt;/IATA&amp;gt;&amp;lt;IATA&amp;gt;MQ&amp;lt;/IATA&amp;gt;&amp;lt;IATA&amp;gt;NA&amp;lt;/IATA&amp;gt;&amp;lt;/AirlineCode&amp;gt;&amp;lt;/Key&amp;gt; &amp;lt;WhatIWant&amp;gt;&amp;lt;Record&amp;gt;Flight/Leg/Stations&amp;lt;/Record&amp;gt;&amp;lt;Record&amp;gt;Flight/Leg/Equipment&amp;lt;/Record&amp;gt;&amp;lt;Record&amp;gt;Flight/Leg/Times&amp;lt;/Record&amp;gt;&amp;lt;Record&amp;gt;Flight/Leg/Fuel&amp;lt;/Record&amp;gt;&amp;lt;Record&amp;gt;Flight/Leg/Planners&amp;lt;/Record&amp;gt;&amp;lt;Record&amp;gt;Flight/Leg/Status&amp;lt;/Record&amp;gt;&amp;lt;Record&amp;gt;Flight/Leg/Type&amp;lt;/Record&amp;gt;&amp;lt;Record&amp;gt;Flight/Alternates&amp;lt;/Record&amp;gt;&amp;lt;Record&amp;gt;Flight/Route&amp;lt;/Record&amp;gt;&amp;lt;/WhatIWant&amp;gt;&amp;lt;/OnDemandRequest&amp;gt;";
//
//			html = StringUtils.unescapeHtml(html);
//
//			System.out.println(html);
//
//			String xx = StringUtils.escapeHtml(html);
//
//			System.out.println(xx);
//
//			String xml = StringUtils.formatXml(html, "OnDemandRequest", 2);
//
//			System.out.println(xml);


			//String filePath = "C:\\" + "\\" + "workspaces\\" + "\\" + "dispauto\\" + "\\" + "DOCS\\" + "\\" + "dispauto_ddl.txt";
			//String filePath = "C:\\workspaces\\dispauto\\DOCS\\dispauto_ddl.txt";
			//String filePath = "C://workspaces//dispauto//DOCS//dispauto_ddl.txt";

			//StringUtils.isAlpha("FaEDc");

//			System.out.println(StringUtils.getFileAsString(filePath));
...
//				codePoint = Character.codePointAt(cArray, i);
//				System.out.println("code point i = " + codePoint);
//				category = Character.getType(cArray[i]);
//				System.out.println("category i = " + category);
//
//				//System.out.println("toString() i = " + cArray[i]);
//			}

//			xml = "   <FirstElement name=\"shutdownDatabase\" type=\"java.lang.String\" value=\"something\"> " + System.getProperty("line.separator");
//			xml = xml + "<SecondElement id=\"s2vc1\" angle=\"left\">  <ThirdElements> <ThirdElement> This is the first instance of the third element </ThirdElement>  " + System.getProperty("line.separator");
//			xml = xml + "<ThirdElement> This is the second instance of the third element </ThirdElement> <ThirdElement> This is the third instance of the third element" + System.getProperty("line.separator");
//			xml = xml + "</ThirdElement>    </ThirdElements></SecondElement></FirstElement>" + System.getProperty("line.separator");
//

//			String filePath = "C:\\_data\\java_projects\\oxygen-jee-workspace\\Rest-Drivers\\resources\\alert-suites\\alert-suite-04\\scenario-1\\step-1.properties";
//
//			String fileBody = "file contents";
//			
//			StringUtils.saveStringAsFile(filePath, fileBody);
...
//			String strFile = StringUtils.getFileAsString("C:\\temp\\logs\\test.log");
//			String temp = StringUtils.formatXml(strFile, "RerouteRequestMessage", 2);
//			System.out.println(temp);

//			long startTime = Calendar.getInstance().getTimeInMillis();
//			System.out.println("Start : " + startTime);
//
//			LineNumberReader reader = new LineNumberReader(new FileReader("C:\\temp\\logs\\test.log"));
//
//			int data = reader.read();
//			int oldLineNumber = 0;
//			int myLineNumber = 0;
//
//			HashMap<Integer, String> lines = new HashMap<Integer, String>(350000);
...
//						System.out.println("Line content : " + buff.toString());
//
//						lines.put(new Integer(myLineNumber), buff.toString().trim());
//						buff = new StringBuffer();
//
//						System.out.println("Current Line Number : " + lineNumber);
//					} else {
//						System.out.println("Line number is " + lineNumber);
//						System.out.println("Empty line content : '" + buff.toString() + "'");
//
//					}
//				}
//			}
//
//			System.out.println("Ending Line Number : " + myLineNumber);
//			long finishTime = Calendar.getInstance().getTimeInMillis();
//			String lineBuff;
//			for (int i = 1; (i < (myLineNumber + 1)); i++) {
//
//				if ((i < 20) || (i > 334390)) {
//					lineBuff = lines.get(new Integer(i));
//					if (lineBuff != null) {
//						System.out.println("Line: " + i + " : " + lineBuff);
//					} else {
//						System.out.println("Line Buffer was NULL");
//						System.out.println("Line Number in loop: " + i);
//					}
//				}
//
//			}
