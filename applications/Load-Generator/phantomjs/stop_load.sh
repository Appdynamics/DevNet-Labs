...
pkill -f appd-sc-home-init
sleep 1s
pkill -f appd-sc-slow-query
sleep 1s
pkill -f appd-sc-session
sleep 1s
pkill -f appd-sc-sell-car
sleep 1s
pkill -f appd-sc-request-error
sleep 1s
pkill -f appd-sc-search
sleep 1s
pkill -f appd-sc-mem-leak-insurance
sleep 1s
