...
<span style="color: red;">TODO:</span> <span style="color: blue;">Add screenshot of upload here.</span>
...
<span style="color: red;">TODO:</span> <span style="color: blue;">Add screenshot of SSH window here.</span>
...
```
Your file should like the abbreviated example below after you have made the changes and saved the file. 
...
Apache Tomcat is installed and running on your "Application VM". Perform the steps below to add the Java agent to the Tomcat startup.
...
```
cd /usr/local/apache/apache-tomcat-7.0.103/bin
```
...
[Sandbox setup](../appd-sandbox-setup-101/1.md) | [1](1.md), [2](2.md), 3, [4](4.md), [5](5.md), [6](6.md), [7](7.md), [8](8.md) | [Back](2.md) | [Next](4.md)    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red;">TODO:</span><span style="color: blue;">&nbsp;&nbsp;Remove menu before moving to staging</span>